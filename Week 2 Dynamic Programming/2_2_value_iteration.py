...
def initialize_random_policy():
    # policy is a lookup table for state -> actions
...
def calculate_greedy_policy(grid, V):
    ...
    # Find a policy that leads to optimal value print_function
    for s in policy.keys():
        grid.set_state(s)
        # loop through all possible actions to fidn the best current action
